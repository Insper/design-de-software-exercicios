...
class TestCase(str_test.TestCaseWrapper):
    ...
    def test_argumentos_true1(self):
        resultado_obtido = self.function("rumo", "muro")
        self.assertTrue(resultado_obtido, msg=f'O resultado obtido foi diferente do esperado. Não identificou um anagrama nas palavras rumo e muro')

    def test_argumentos_true2(self):
        resultado_obtido = self.function("alegria", "alergia")
        self.assertTrue(resultado_obtido, msg=f'O resultado obtido foi diferente do esperado. Não identificou um anagrama nas palavras alegria e alergia')

    def test_argumentos_true3(self):
        resultado_obtido = self.function("carro", "corar")
        self.assertTrue(resultado_obtido, msg=f'O resultado obtido foi diferente do esperado. Não identificou um anagrama nas palavras carro e corar')

    def test_argumentos_true4(self):
        resultado_obtido = self.function("CARRO", "CORAR")
        self.assertTrue(resultado_obtido, msg=f'O resultado obtido foi diferente do esperado. Não identificou um anagrama nas palavras com letras maiúsculas (CARRO e CORAR)')


    def test_argumentos_false(self):
        resultado_obtido = self.function("remo", "muro")
        self.assertFalse(resultado_obtido, msg=f'O resultado obtido foi diferente do esperado. Identificou um anagrama que não existe nas palavras remo e muro')
